...
* 类说明 
*/
@WebServlet("/doQueryByCategory2")
public class UserQueryByCategory2Servlet extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//调用service层方法，按角色扮演类型查询游戏信息
		QueryServiceImpl qs = new QueryServiceImpl();
		List<Map<String, Object>> list = qs.QueryByGameCategory2();
		//设置属性的值
