...
<!-- title of site -->
<title>Admin Add Game Info</title>
						...
						<div class="col-sm-12">
							<div class="signin-form">
								<form id="ff">
									...
									<div class="form-group">
										<label for="signin_form">厂商：</label> 
									...
									<div class="form-group">
										<label for="signin_form">上架日期：</label> 
										<input type="text" class="form-control" name="startdate" />
									</div>
									
									<div class="form-group">
										<label for="signin_form">是否上架：</label> 
										<input type="text" class="form-control" name="status" />
									</div>
									
									<div class="form-group">
										<label for="signin_form">简介：</label> 
