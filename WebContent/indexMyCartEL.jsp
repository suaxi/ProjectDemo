...
<c:forEach var="game" items="${list}">
	<tr>				
					...
					<th><h3>&nbsp;&nbsp;${game.count}</h3></th>
					<th><a href="doAddGoodsCount?CartId=${game.id}"><h3>&nbsp;&nbsp;+</h3></a></th>
					<th><a href="doSubGoodsCount?CartId=${game.id}"><h3>&nbsp;&nbsp;-</h3></a></th>
				</tr>					
</c:forEach>	
</table>
	</div>
	<div align="right"><a href="doCleanCart"><h3>清空购物车</h3></a></div>
	</section><!-- end main -->
